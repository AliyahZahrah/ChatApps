...
class ChatScreenAliyah extends StatefulWidget {
  final String contactName;

  const ChatScreenAliyah({Key? key, required this.contactName})
      : super(key: key);

  @override
  _ChatScreenStateAliyah createState() => _ChatScreenStateAliyah();
}

class _ChatScreenStateAliyah extends State<ChatScreenAliyah> {
  ...
  void _initializeMessages() {
    ...
    if (contact != null) {
      ...
      _messages = [
        ...
        ChatMessage(
          text:
              "Sedikit cerita, gue kemarin barusan ke pantai yg di kuta itu lho",
          isUser: false,
          senderName: widget.contactName,
        ),
        ChatMessage(
