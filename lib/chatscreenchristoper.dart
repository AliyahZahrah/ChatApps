...
class ChatScreenChristoper extends StatefulWidget {
  final String contactName;

  const ChatScreenChristoper({Key? key, required this.contactName})
      : super(key: key);

  @override
  _ChatScreenStatechristoper createState() => _ChatScreenStatechristoper();
}

class _ChatScreenStatechristoper extends State<ChatScreenChristoper> {
  ...
  void _initializeMessages() {
    ...
    if (contact != null) {
      ...
      _messages = [
        ChatMessage(
          text: "Cin, hari ini jadi meeting?",
          isUser: false,
        ...
        ChatMessage(
          text: "Lewat apa emang? ms teams?",
          isUser: false,
          senderName: widget.contactName,
        ),
        const ChatMessage(
          text: "boleh ntar lu jgn lupa record ya",
          isUser: true,
          senderName: "Cindy",
        ),
        ChatMessage(
          text: "Aduh memori gue penuh lu aja ya",
          isUser: false,
          senderName: widget.contactName,
        ),
      ];
