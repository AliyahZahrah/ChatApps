...
class ChatScreenHansel extends StatefulWidget {
  final String contactName;

  const ChatScreenHansel({Key? key, required this.contactName})
      : super(key: key);

  @override
  _ChatScreenHanselState createState() => _ChatScreenHanselState();
}

class _ChatScreenHanselState extends State<ChatScreenHansel> {
  ...
  void _initializeMessages() {
    ...
    _messages = [
      ...
      ChatMessage(
        text: "nasgor dia enak bgt cuy cobain dah",
        isUser: false,
        senderName: widget.contactName,
      ),
      const ChatMessage(
