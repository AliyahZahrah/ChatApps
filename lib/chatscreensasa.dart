...
class ChatScreenSasa extends StatefulWidget {
  final String contactName;

  const ChatScreenSasa({Key? key, required this.contactName}) : super(key: key);

  @override
  _ChatScreenStateSasa createState() => _ChatScreenStateSasa();
}

class _ChatScreenStateSasa extends State<ChatScreenSasa> {
  ...
  void _initializeMessages() {
    ...
    if (contact != null) {
      ...
      _messages = [
        ChatMessage(
          text: "Eh, kemarin gimana tugas kita?",
          isUser: false,
