...
class ChatScreenTiara extends StatefulWidget {
  final String contactName;

  const ChatScreenTiara({Key? key, required this.contactName})
      : super(key: key);

  @override
  _ChatScreenTiaraState createState() => _ChatScreenTiaraState();
}

class _ChatScreenTiaraState extends State<ChatScreenTiara> {
  ...
  void initState() {
    super.initState();
    _initializeMessages(); // Panggil inisialisasi pesan di sini
  }
  ...
  void _initializeMessages() {
    ...
    _messages = [
      ChatMessage(
        text: "tugas chatapps kita yang kemarin progress sampe mana ra?",
        isUser: true,
        senderName: "Cindy",
      ),
      ChatMessage(
        text: "udah hampir slesai sih kenapa?",
        isUser: false,
        senderName: widget.contactName,
      ),
      ChatMessage(
        text: "gakpapa bilang aja kalo ada yang perlu gue bantu",
        isUser: true,
        senderName: "Cindy",
      ),
      ChatMessage(
